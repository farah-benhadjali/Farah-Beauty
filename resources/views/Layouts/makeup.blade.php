...
<link rel="stylesheet" type="text/css" href="{{asset('assets/css/categories.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('assets/css/categories_responsive.css')}}">
</head>
<body>
...
<div class="super_container">
	...
	<div class="home">
		<div class="home_background parallax-window" data-parallax="scroll" data-image-src="{{asset('assets/images/master.jpg')}}" data-speed="0.8"></div>
		<div class="container">
			<div class="row">
				<div class="col">
						...
						<div class="sidebar_section">
							...
							<div class="sidebar_section_content bestsellers_content">
								<ul>
									<!-- Best Seller Item -->
									<li class="clearfix">
										<div class="best_image"><img src="{{asset('assets/images/best_1.jpg')}}" alt=""></div>
										<div class="best_content">
											<div class="best_title"><a href="{{route('product')}}">Blue dress with dots</a></div>
									...
									<!-- Best Seller Item -->
									<li class="clearfix">
										<div class="best_image"><img src="{{asset('assets/images/best_2.jpg')}}" alt=""></div>
										<div class="best_content">
											<div class="best_title"><a href="{{route('product')}}">White t-shirt</a></div>
											<div class="best_price">$45</div>
										</div>
										<div class="best_buy">+</div>
									</li>
									...
									<!-- Best Seller Item -->
									<li class="clearfix">
										<div class="best_image"><img src="{{asset('assets/images/best_3.jpg')}}" alt=""></div>
										<div class="best_content">
											<div class="best_title"><a href="{{route('product')}}">Blue dress with dots</a></div>
											<div class="best_price">$45</div>
										</div>
									...
									<!-- Best Seller Item -->
									<li class="clearfix">
										<div class="best_image"><img src="{{asset('assets/images/best_4.jpg')}}" alt=""></div>
										<div class="best_content">
											<div class="best_title"><a href="{{route('product')}}">White t-shirt</a></div>
											<div class="best_price">$45</div>
										</div>
			...
			<div class="row products_container">
				<div class="col">
					...
					<div class="product_grid">
						...
						<!-- Product -->
						<div class="product">
							<div class="product_image"><img src="{{asset('assets/images/product_9.jpg')}}" alt=""></div>
							<div class="rating rating_3" data-rating="3">
								<i class="fa fa-star"></i>
								<i class="fa fa-star"></i>
								<i class="fa fa-star"></i>
						...
						<!-- Product -->
						<div class="product">
							<div class="product_image"><img src="{{asset('assets/images/product_10.jpg')}}" alt=""></div>
							<div class="rating rating_3" data-rating="3">
								<i class="fa fa-star"></i>
								<i class="fa fa-star"></i>
								<i class="fa fa-star"></i>
						...
						<!-- Product -->
						<div class="product">
							<div class="product_image"><img src="{{asset('assets/images/product_11.jpg')}}" alt=""></div>
							<div class="rating rating_3" data-rating="3">
								<i class="fa fa-star"></i>
								<i class="fa fa-star"></i>
								<i class="fa fa-star"></i>
						...
						<!-- Product -->
						<div class="product">
							<div class="product_image"><img src="{{asset('assets/images/product_12.jpg')}}" alt=""></div>
							<div class="rating rating_3" data-rating="3">
								<i class="fa fa-star"></i>
								<i class="fa fa-star"></i>
								<i class="fa fa-star"></i>
		...
		<div class="sidebar_right clearfix">
			...
			<div class="sidebar_promo_1 sidebar_promo d-flex flex-column align-items-center justify-content-center">
				...
				<div class="sidebar_promo_content text-center">
					...
					<div class="sidebar_promo_button"><a href="{{route('checkout')}}">check out</a></div>
				</div>
			</div>
